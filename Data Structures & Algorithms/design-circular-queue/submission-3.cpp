...
public:
    ...
    // Optional: but best practice as we allocated memory manually
    ~MyCircularQueue() {
    ...
    bool deQueue() {
        ...
        // For non-primitive types we'd call the destructor here
        // But since it's an int we can just simply overwrite it.
